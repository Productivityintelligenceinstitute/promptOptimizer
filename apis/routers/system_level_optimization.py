...
from llm.chain_builder import build_system_level_optimization_chain, build_chat_title_generation_chain
...
system_level_optimization_router = APIRouter()

@system_level_optimization_router.post("/system-level-optimization")
