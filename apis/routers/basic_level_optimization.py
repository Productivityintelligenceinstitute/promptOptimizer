...
from llm.chain_builder import build_basic_level_optimization_chain, build_chat_title_generation_chain
...
basic_level_optimization_router = APIRouter()

@basic_level_optimization_router.post("/basic-level-optimization")
